import { LessonsSchema, type Lesson } from './lessonSchema.js';

// Canonical starter-lesson content — the single copy both packages/web
// (imports this module directly) and packages/mobile (reads a generated
// JSON asset, see scripts/generate-mobile-content.mjs) read from. Moved
// here from packages/web/src/features/marketing/content.ts in Slice 3 to
// stop that from being the only place this content could live — see
// 05_IMPLEMENTATION_HANDOFF.md's Slice 3 step 1.
...
export const lessons: Lesson[] = LessonsSchema.parse(rawLessons);
